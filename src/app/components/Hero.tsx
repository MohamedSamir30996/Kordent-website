...
export function Hero() {
  ...
  return (
    <div className="relative h-screen overflow-hidden">
      ...
      <div className="absolute left-8 md:left-12 bottom-32 z-10">
        <Link to="/equipment">
          <motion.button
      ...
      <div className="absolute right-8 md:right-12 bottom-32 z-10 flex flex-col gap-4">
        <motion.a
          ...
          className="w-12 h-12 rounded-full bg-white/90 backdrop-blur-sm flex items-center justify-center hover:bg-[#DC2626] hover:text-white transition-all shadow-lg"
        >
