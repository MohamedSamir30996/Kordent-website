import imgHeroDesktop from "../../assets/figma/hero-2.png";
import imgHeroMobile from "../../assets/figma/Hero 2 mobile.png";
...
export default function HeroSection() {
  return (
    <div className="overflow-clip relative max-md:rounded-none rounded-[16px] size-full" data-name="Hero section 2">
